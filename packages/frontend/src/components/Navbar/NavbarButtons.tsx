...
const NavbarButtons: React.FC<NavbarButtonsProps> = ({ className }) => {
  return (
    <>
        <ExternalLinkComponent className={className} href={"https://discord.com/oauth2/authorize?client_id=907449509133561888&permissions=8&scope=bot%20applications.commands"}>
            Invite
